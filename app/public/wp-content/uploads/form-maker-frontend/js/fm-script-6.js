    ...
    var labels_and_ids6 = {"2":"type_spinner","5":"type_spinner","4":"type_spinner","3":"type_spinner"};
    var check_regExp_all6 = [];
    var check_paypal_price_min_max6 = [];
    var file_upload_check6 = [];
    var spinner_check6 = {"2":["",""],"5":["",""],"4":["",""],"3":["",""]};
...
function after_submit6() {
    ...
    function onload_js6() {
  jQuery("#form6 #wdform_2_element6")[0].spin = null;
  spinner = jQuery("#form6 #wdform_2_element6").spinner();
  if ("null" == "null" && jQuery("#form6 #wdform_2_element6").val() == "") { spinner.spinner("value", ""); }
  jQuery("#form6 #wdform_2_element6").spinner({ min: ""});
  jQuery("#form6 #wdform_2_element6").spinner({ max: ""});
  jQuery("#form6 #wdform_2_element6").spinner({ step: "1"});
  ...
  jQuery("#form6 #wdform_5_element6").spinner({ min: ""});
  ...
  jQuery("#form6 #wdform_4_element6").spinner({ min: ""});
