    ...
    var labels_and_ids5 = {"6":"type_spinner","9":"type_spinner","10":"type_spinner","11":"type_spinner","7":"type_textarea","1":"type_submit_reset"};
    var check_regExp_all5 = [];
    var check_paypal_price_min_max5 = [];
    var file_upload_check5 = [];
    var spinner_check5 = {"6":["",""],"9":["",""],"10":["",""],"11":["",""]};
...
function after_submit5() {
  ...
  jQuery("#form5 #wdform_9_element5")[0].spin = null;
  spinner = jQuery("#form5 #wdform_9_element5").spinner();
  if ("null" == "null" && jQuery("#form5 #wdform_9_element5").val() == "") { spinner.spinner("value", ""); }
  jQuery("#form5 #wdform_9_element5").spinner({ min: ""});
  jQuery("#form5 #wdform_9_element5").spinner({ max: ""});
  jQuery("#form5 #wdform_9_element5").spinner({ step: "1"});
  jQuery("#form5 #wdform_10_element5")[0].spin = null;
  spinner = jQuery("#form5 #wdform_10_element5").spinner();
  if ("null" == "null" && jQuery("#form5 #wdform_10_element5").val() == "") { spinner.spinner("value", ""); }
  jQuery("#form5 #wdform_10_element5").spinner({ min: ""});
  jQuery("#form5 #wdform_10_element5").spinner({ max: ""});
  jQuery("#form5 #wdform_10_element5").spinner({ step: "1"});
  jQuery("#form5 #wdform_11_element5")[0].spin = null;
  spinner = jQuery("#form5 #wdform_11_element5").spinner();
  if ("null" == "null" && jQuery("#form5 #wdform_11_element5").val() == "") { spinner.spinner("value", ""); }
  jQuery("#form5 #wdform_11_element5").spinner({ min: ""});
  jQuery("#form5 #wdform_11_element5").spinner({ max: ""});
  jQuery("#form5 #wdform_11_element5").spinner({ step: "1"});    }
